...
# Converted on Fri, 06 Dec 2019 00:05:33 +0000
...
CREATE TABLE goal_details (
    ...
    play_stage varchar(1) NOT NULL,
    goal_schedule varchar(2) NOT NULL,
    goal_half numeric
) ENGINE=InnoDB;
...
CREATE TABLE player_booked (
    ...
    play_schedule varchar(2) NOT NULL,
...
ALTER TABLE soccer_team
    ADD CONSTRAINT soccer_team_pkey PRIMARY KEY (team_id);
